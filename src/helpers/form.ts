...
export function mapGetPrimaryFormToPrimaryFormType(
  ...
  return {
    ...
    vehicleSeriesLabel: data.vehicleSeriesLabel,
    vehicleSeriesInfoTitle: data.vehicleSeriesInfoTitle,
    vehicleSeriesInfoDescription: data.vehicleSeriesInfoDescription,
