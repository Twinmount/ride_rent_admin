...
/**
 * City FAQ Form component - follows same visual pattern as SeriesFaqForm
 * but integrates with the /content-faq API for city FAQ operations
 */
